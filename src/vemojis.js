...
export default class VEmojis extends Plugin {
	...
	init() {
		...
		editor.ui.componentFactory.add( 'VEmojis', locale => {
	...
	addItems( groupName, items ) {
		if ( groupName === ALL_EMOJI_CHARACTERS_GROUP ) {
			throw new CKEditorError( `The name "${ ALL_EMOJI_CHARACTERS_GROUP }" is reserved and cannot be used.` );
		}
	...
	_createDropdownPanelContent( locale, dropdownView ) {
		...
		navigationView.on( 'execute', () => {
			this._updateGrid( navigationView.currentGroupName || ALL_EMOJI_CHARACTERS_GROUP, gridView );
		} );
